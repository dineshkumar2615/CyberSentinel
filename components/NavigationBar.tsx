...
export default function Navigation() {
    ...
    return (
        <>
            ...
            <nav className={`md:hidden fixed bottom-0 left-0 right-0 bg-[var(--background)]/90 backdrop-blur-xl border-t border-[var(--glass-border)] z-50 pb-safe transition-colors duration-300 ${['/login', '/signup'].includes(pathname) ? 'hidden' : ''}`}>
